...
def generate_brochure(company_name, website_url):
    for chunk in stream_brochure(company_name, website_url):
        yield chunk


with gr.Blocks(title="AI Sales Brochure Generator") as demo:

    gr.Markdown("# AI Sales Brochure Generator")
